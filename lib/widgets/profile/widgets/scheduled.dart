...
class Scheduled extends StatelessWidget {
  ...
  final List<ScheduledModel> scheduled = [
    ScheduledModel(title: "Testing Dep. Meeting", date: "Today, 9AM - 10AM"),
    ScheduledModel(title: "Board Meeting", date: "Tomorrow, 5PM - 6PM"),
    ScheduledModel(
        title: "Anhad Celebration 2024", date: "Wednesday, 9AM - 10AM"),
  ];
