...
class _MenuState extends State<Menu> {
  List<MenuModel> menu = [
    ...
    MenuModel(icon: 'assets/svg/exercise.svg', title: "Control"),
    MenuModel(icon: 'assets/svg/setting.svg', title: "Production"),
    MenuModel(icon: 'assets/svg/history.svg', title: "Tracking"),
